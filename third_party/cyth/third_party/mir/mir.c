...
static const struct insn_desc insn_descs[] = {
  ...
  {MIR_I2FS, "i2fs", {MIR_OP_FLOAT | OUT_FLAG, MIR_OP_INT, MIR_OP_BOUND}},
  ...
  {MIR_F2IS, "f2is", {MIR_OP_INT | OUT_FLAG, MIR_OP_FLOAT, MIR_OP_BOUND}},
  ...
  {MIR_F2U, "f2u", {MIR_OP_INT | OUT_FLAG, MIR_OP_FLOAT, MIR_OP_BOUND}},
  {MIR_STP, "stp", {MIR_OP_INT | OUT_FLAG, MIR_OP_INT, MIR_OP_INT, MIR_OP_INT, MIR_OP_BOUND}},
  {MIR_LDP, "ldp", {MIR_OP_INT | OUT_FLAG, MIR_OP_INT, MIR_OP_INT, MIR_OP_INT, MIR_OP_BOUND}},
...
#if defined(_M_AMD64) || __SIZEOF_LONG_DOUBLE__ == 8
